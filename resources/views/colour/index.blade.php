 ...
 <section class="content-header">
  ...
  <section class="content">
    <div class="alert alert-primary">
        ...
        Halaman ini adalah halaman <strong>Warna</strong>. Anda dapat mendaftarkan dan memanajemen <strong>Daftar Warna</strong> yang terdapat didalam sistem.<br>
        <br> <strong>Cara penggunaan :</strong>
        <ul>
            <li>
                <p class="my-0 py-0">
                    <i class="fas fa-plus"></i> <strong>Tambah Warna Baru</strong> : Untuk menambah dan memasukkan informasi <strong>Warna Baru</strong> kedalam sistem.
                </p>
            </li>
            <li>
                <p class="my-0 py-0">
                    <i class="fas fa-pencil-alt"></i> <strong>Ubah</strong> : Untuk melakukan <strong>Perubahan Informasi Warna</strong> yang terdapat didalam sistem.
                </p>
            </li>
            <li>
                <p class="my-0 py-0">
                    <i class="fas fa-trash"></i> <strong> Hapus </strong>: Untuk melakukan <strong>Penghapusan Data Warna</strong> yang terdapat didalam sistem.<strong>Pastikan tidak ada data atau informasi yang menggunakan Warna yang akan dihapus.</strong>
                </p>
            </li>
        </ul>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-tools input-group">
                ...
                <a href="{{url('admin/colours/create')}}" class=" btn btn-primary float-right rounded-pill"
                data-target="#showcreatemodal" data-toggle='modal' onclick="showCreate()"><i class="fas fa-plus"></i> Tambah Warna Baru</a>
            </div>
            ...
            <tbody>
                ...
                <tr id='tr{{$d->id}}'>
                    ...
                    <td class="project-actions text-right">
                        <a class="btn btn-outline-info rounded-pill" href="{{url('admin/colours/'.$d->id.'/edit')}}"
                            data-target="#edit{{$d->id}}" data-toggle='modal' onclick="showEdit({{$d->id}})">
                            <i class="fas fa-pencil-alt">
                            </i>
                            Ubah
                        </a>
                        <a class="btn btn-outline-danger rounded-pill" href="{{url('admin/colours/'.$d->id)}}"
                                ...
                                <div class="modal-content" id="colourdelete{{$d->id}}">
                                    ...
                                    <form method='POST' action="{{route('colours.destroy', $d->id)}}">
                                        ...
                                        <div class="modal-header d-flex justify-content-between my-0 py-0 border-0">
                                            ...
                                            <h4 class="modal-title"><i class="fa-solid fa-trash"></i> Hapus Warna</h4>
                                            </div>
                                          </div>
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-danger rounded-pill float-right"><i class="fas fa-trash"></i> Hapus Warna</button>
                                            </div>
                                          </div>
                                    </form>
                                    </div>
