 ...
 <section class="content-header">
  ...
  <section class="content">
        <div class="alert alert-primary">
            ...
            Halaman ini adalah halaman <strong>Merek</strong>. Anda dapat mendaftarkan dan memanajemen <strong>Daftar Merek</strong> yang terdapat didalam sistem.<br>
            <br> <strong>Cara penggunaan :</strong>
            <ul>
                <li>
                    <p class="my-0 py-0">
                        <i class="fas fa-plus"></i> <strong>Tambah Merek Baru</strong> : Untuk menambah dan memasukkan informasi <strong>Merek Baru</strong> kedalam sistem.
                    </p>
                </li>
                <li>
                    <p class="my-0 py-0">
                        <i class="fas fa-pencil-alt"></i> <strong>Ubah </strong>: Untuk melakukan <strong>Perubahan Informasi Merek</strong> yang terdapat didalam sistem.
                    </p>
                </li>
                <li>
                    <p class="my-0 py-0">
                        <i class="fas fa-trash"></i> <strong> Hapus </strong>: Untuk melakukan <strong>Penghapusan Data Merek</strong> yang terdapat didalam sistem. <strong>Pastikan tidak ada data atau informasi yang menggunakan Merek yang akan dihapus.</strong>
                    </p>
                </li>
            </ul>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-tools input-group">
                ...
                <a href="{{url('admin/brands/create')}}" class=" btn btn-primary rounded float-right rounded-pill"
                data-target="#showcreatemodal" data-toggle='modal' onclick="showCreate()"> <i class="fas fa-plus"></i> Tambah Merek Baru</a>
            </div>
            ...
            <tbody>
                ...
                <tr id='tr{{$d->id}}'>
                    ...
                    <td class="project-actions text-right">
                        <a class="btn btn-outline-info rounded-pill" href="{{url('admin/brands/'.$d->id.'/edit')}}"
                            data-target="#edit{{$d->id}}" data-toggle='modal' onclick="showEdit({{$d->id}})">
                            <i class="fas fa-pencil-alt">
                            </i>
                            Ubah
                        </a>
                        <a class="btn btn-outline-danger rounded-pill" href="{{url('admin/brands/'.$d->id)}}"
                                    ...
                                    <form method='POST' action="{{route('brands.destroy', $d->id)}}">
                                        ...
                                        <div class="modal-header d-flex justify-content-between my-0 py-0 border-0">
                                          ...
                                          <div class="modal-footer justify-content-between">
                                            ...
                                            <button type="submit" class="btn btn-danger rounded-pill"><i class="fas fa-trash"></i> Hapus Merek</button>
                                          </div>
                                    </form>
                                    </div>
                                </div>
