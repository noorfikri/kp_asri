    ...
    <div class="card">
        <div class="card-header">
            <div class="card-tools input-group">
                ...
                <a href="{{url('admin/sizes/create')}}" class=" btn btn-primary rounded float-right"
            ...
            <tbody>
                ...
                <tr id='tr{{$d->id}}'>
                    ...
                    <td class="project-actions text-right">
                        <a class="btn btn-info btn-sm" href="{{url('admin/sizes/'.$d->id.'/edit')}}"
                            data-target="#edit{{$d->id}}" data-toggle='modal' onclick="showEdit({{$d->id}})">
                            <i class="fas fa-pencil-alt">
                            </i>
                            Ubah
                        </a>
                        <a class="btn btn-danger btn-sm" href="{{url('admin/sizes/'.$d->id)}}"
                                    ...
                                    <form method='POST' action="{{route('sizes.destroy', $d->id)}}">
                                        ...
                                        <div class="modal-header bg-danger">
                                          ...
                                          <div class="modal-footer justify-content-between">
                                            ...
                                            <button type="submit" class="btn btn-danger">Hapus Ukuran</button>
                                          </div>
                                    </form>
                                </div>
                            </div>
